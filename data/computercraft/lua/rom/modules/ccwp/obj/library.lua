...
function library.Setup()
    ...
    moduleRegistry:requireAndRegisterModule("T_Object", "test.t_object")
    ...
    moduleRegistry:requireAndRegisterModule("T_IItemSupplier", "test.t_iitem_supplier")
    moduleRegistry:requireAndRegisterModule("T_IItemDepot", "test.t_iitem_depot")
